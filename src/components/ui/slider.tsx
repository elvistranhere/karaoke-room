      ...
      >
        ...
        {Array.from({ length: _values.length }, (_, index) => (
          <SliderPrimitive.Thumb
            ...
            aria-label={ariaLabel}
            aria-labelledby={ariaLabelledBy}
            className="relative block size-4 shrink-0 rounded-full border border-[var(--slider-accent,var(--primary))] bg-[var(--slider-accent,var(--primary))] ring-ring/50 transition-[color,box-shadow] select-none after:absolute after:-inset-2 hover:ring-3 focus-visible:ring-3 focus-visible:outline-hidden active:ring-3 disabled:pointer-events-none disabled:opacity-50"
          />
        ))}
      </SliderPrimitive.Control>
    </SliderPrimitive.Root>
