  ...
  return (
    <>
      ...
      >
        ...
        {/* Download + convert guidance */}
        <div className="mb-3 space-y-2">
          <button
            onClick={handleDownload}
            className="flex w-full cursor-pointer items-center justify-center gap-1.5 rounded-lg py-2.5 text-xs font-bold transition-all hover:brightness-110"
